  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        'emerald-sm': '0 2px 4px -1px rgba(5, 150, 105, 0.15), 0 1px 2px -1px rgba(5, 150, 105, 0.10)',
        'emerald': '0 4px 8px -2px rgba(5, 150, 105, 0.20), 0 2px 4px -1px rgba(5, 150, 105, 0.12)',
        'emerald-lg': '0 8px 16px -4px rgba(5, 150, 105, 0.25), 0 4px 8px -2px rgba(5, 150, 105, 0.15)',
