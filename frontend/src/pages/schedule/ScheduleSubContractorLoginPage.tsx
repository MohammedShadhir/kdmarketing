...
export function ScheduleSubContractorLoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await login(email, password, 'subcontractor');
      navigate('/schedule');
    } catch (err: any) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-cyan-50 to-teal-50 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Sub-Contractor Login</h1>
          <p className="text-gray-600">Access your project schedule</p>
        </div>
